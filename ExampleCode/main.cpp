...
// Integrate comoving distance
    ...
    double chi = gauss_kronrod<double, 15>::integrate(comoving_distance_integrand,
                                                      z0, z,
...
// [TODO] Output in Mpc/h
//     double h = background.H0_in_km_over_s_Mpc / 100.;
//     std::cout << "The comoving distance at z=" << z << " is chi=" << chi * h << " Mpc/h\n";
